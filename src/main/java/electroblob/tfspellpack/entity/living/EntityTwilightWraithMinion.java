...
public class EntityTwilightWraithMinion extends EntityTFWraith implements ISummonedCreature {
	...
	public EntityTwilightWraithMinion(World world){
		super(world);
	...
	protected void initEntityAI() {
		...
		this.targetTasks.addTask(2, new EntityAIFindNearestTarget(this, this.getTargetSelector()));
	}

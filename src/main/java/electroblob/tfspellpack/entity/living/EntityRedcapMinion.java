...
public class EntityRedcapMinion extends EntityTFRedcap implements ISummonedCreature {
	...
	public EntityRedcapMinion(World world){
		super(world);
		...
		if(this.world.isRemote){
			for(int i = 0; i < 15; i++){
				this.world.spawnParticle(EnumParticleTypes.SMOKE_LARGE, this.posX + this.rand.nextFloat() - 0.5f,
						this.posY + this.rand.nextFloat() * 1.4, this.posZ + this.rand.nextFloat() - 0.5f, 0, 0, 0);
			}
		}
	}
